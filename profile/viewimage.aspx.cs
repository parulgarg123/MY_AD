...
public partial class profile_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label2_notsuccess.Visible = false;
        ...
        dl.DataBind();
        con.Close();
        Button1_approve.Visible = true;
        Button2_reject.Visible = true;
        Button3_change.Visible = true;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Button1_approve.Visible = false;
        Button2_reject.Visible = false;
        Button3_change.Visible = false;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        Label2_notsuccess.Visible = true;
        Label2_notsuccess.Text = ("OOPS!!! We will try our best with next Advertisement.");
        Button1_approve.Visible = false;
        Button2_reject.Visible = false;
        Button3_change.Visible = false;
